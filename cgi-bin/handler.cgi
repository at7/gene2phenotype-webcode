...
sub init_CGI { 
  ...
  $session->flush();
  if (!$cgi->param('edit_DDD_category') && !$cgi->param('edit_GFD_action') && !$cgi->param('add_GFD_action') && !$cgi->param('add_GFD_publication_comment') && !$cgi->param('delete_GFD_publication_comment')) {
